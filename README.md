# 👋 Merhaba, Ben Ilgın Demir!

🩺 **Geleceğin Hekimi & Bugünün Altyapı ve AI Geliştiricisi**
17 yaşında bir lise öğrencisi ve yazılım geliştiriciyim. En büyük hedefim tıp fakültesinde okumak. Bu süreçte tıp eğitimimi finanse etmek ve sağlık teknolojilerinin geleceğine hazırlanmak için kurumsal mimaride web, mobil ve yapay zekâ uygulamaları geliştirip satıyorum.

---

### 🚀 Öne Çıkan Projelerim & Ürünlerim
...
### 🛠️ Teknolojilerim & Yetkinlikler

* **Frontend & Mobil:** Flutter | Dart | Next.js | TypeScript | Tailwind CSS
* **Backend & Veri:** Python | FastAPI | PostgreSQL (+pgvector) | Redis | Docker
* **Mimari & Güvenlik:** Modular Monolith | Secure Design (Zero-Trust) | Hybrid RAG | WebSockets

---

### 📌 Geliştirme İlkelerim
...
* 💼 Proje satın alımları, lisanslama veya iş birlikleri için GitHub üzerinden repoları inceleyebilir veya [kantinx.com](https://kantinx.com) üzerinden iletişime geçebilirsiniz.
